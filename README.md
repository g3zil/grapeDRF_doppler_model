...
The script is called with two mandatory command line arguments, the subdirectory callsign and start datetime as in modefinder.py. An optional third argument DB triggers data upload to a local Clickhouse database (See Appendix A below for installing Clickhouse):
```
